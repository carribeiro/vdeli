...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CustomerLogfile'
        db.create_table('videorepo_customerlogfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('fpath', self.gf('django.db.models.fields.CharField')(max_length=360)),
            ('creation_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('videorepo', ['CustomerLogfile'])


    def backwards(self, orm):
        
        # Deleting model 'CustomerLogfile'
        db.delete_table('videorepo_customerlogfile')
