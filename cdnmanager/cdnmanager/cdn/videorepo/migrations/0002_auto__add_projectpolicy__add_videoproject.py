...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProjectPolicy'
        db.create_table('videorepo_projectpolicy', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('video_project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videorepo.VideoProject'])),
            ('cdnregion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videorepo.CDNRegion'])),
            ...
            ('max_bandwidth_per_segment_mbps', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('videorepo', ['ProjectPolicy'])

        # Adding model 'VideoProject'
        db.create_table('videorepo_videoproject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('videorepo', ['VideoProject'])


    def backwards(self, orm):
        
        # Deleting model 'ProjectPolicy'
        db.delete_table('videorepo_projectpolicy')

        # Deleting model 'VideoProject'
        db.delete_table('videorepo_videoproject')
    ...
    models = {
        ...
        'videorepo.projectpolicy': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_bandwidth_per_segment_mbps': ('django.db.models.fields.IntegerField', [], {}),
