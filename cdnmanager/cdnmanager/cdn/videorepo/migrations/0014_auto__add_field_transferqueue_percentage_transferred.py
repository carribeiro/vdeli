...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TransferQueue.percentage_transferred'
        db.add_column('videorepo_transferqueue', 'percentage_transferred', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TransferQueue.percentage_transferred'
        db.delete_column('videorepo_transferqueue', 'percentage_transferred')
