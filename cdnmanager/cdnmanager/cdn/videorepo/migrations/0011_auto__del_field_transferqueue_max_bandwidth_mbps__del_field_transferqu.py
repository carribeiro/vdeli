...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TransferQueue.max_bandwidth_mbps'
        db.delete_column('videorepo_transferqueue', 'max_bandwidth_mbps')

        # Deleting field 'TransferQueue.current_segments'
        db.delete_column('videorepo_transferqueue', 'current_segments')

        # Deleting field 'TransferQueue.segment_size'
        db.delete_column('videorepo_transferqueue', 'segment_size')

        # Adding field 'TransferQueue.segment_size_kb'
        db.add_column('videorepo_transferqueue', 'segment_size_kb', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'TransferQueue.max_bandwidth_kbps'
        db.add_column('videorepo_transferqueue', 'max_bandwidth_kbps', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'TransferQueue.max_bandwidth_mbps'
        db.add_column('videorepo_transferqueue', 'max_bandwidth_mbps', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'TransferQueue.current_segments'
        db.add_column('videorepo_transferqueue', 'current_segments', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'TransferQueue.segment_size'
        db.add_column('videorepo_transferqueue', 'segment_size', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'TransferQueue.segment_size_kb'
        db.delete_column('videorepo_transferqueue', 'segment_size_kb')

        # Deleting field 'TransferQueue.max_bandwidth_kbps'
        db.delete_column('videorepo_transferqueue', 'max_bandwidth_kbps')
    ...
    models = {
        ...
        'videorepo.projectpolicy': {
            ...
            'end_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(4, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(23, 0)'}),
