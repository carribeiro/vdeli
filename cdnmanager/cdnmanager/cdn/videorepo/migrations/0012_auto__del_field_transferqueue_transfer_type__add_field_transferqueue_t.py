...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TransferQueue.transfer_type'
        db.delete_column('videorepo_transferqueue', 'transfer_type')

        # Adding field 'TransferQueue.transfer_method'
        db.add_column('videorepo_transferqueue', 'transfer_method', self.gf('django.db.models.fields.CharField')(default='Single FTP', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'TransferQueue.transfer_type'
        db.add_column('videorepo_transferqueue', 'transfer_type', self.gf('django.db.models.fields.CharField')(default='Single FTP', max_length=15), keep_default=False)

        # Deleting field 'TransferQueue.transfer_method'
        db.delete_column('videorepo_transferqueue', 'transfer_method')
