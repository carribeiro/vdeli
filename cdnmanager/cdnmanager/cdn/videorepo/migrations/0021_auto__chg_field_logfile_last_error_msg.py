...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Logfile.last_error_msg'
        db.alter_column('videorepo_logfile', 'last_error_msg', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Logfile.last_error_msg'
        db.alter_column('videorepo_logfile', 'last_error_msg', self.gf('django.db.models.fields.CharField')(default='None', max_length=100))
