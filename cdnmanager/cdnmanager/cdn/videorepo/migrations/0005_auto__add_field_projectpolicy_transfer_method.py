...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectPolicy.transfer_method'
        db.add_column('videorepo_projectpolicy', 'transfer_method', self.gf('django.db.models.fields.CharField')(default='Single FTP', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProjectPolicy.transfer_method'
        db.delete_column('videorepo_projectpolicy', 'transfer_method')
