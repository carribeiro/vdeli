...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TransferQueue.last_error_msg'
        db.add_column('videorepo_transferqueue', 'last_error_msg', self.gf('django.db.models.fields.CharField')(default='No Errors', max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TransferQueue.last_error_msg'
        db.delete_column('videorepo_transferqueue', 'last_error_msg')
    ...
    models = {
        ...
        'videorepo.logfile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_error_msg': ('django.db.models.fields.CharField', [], {'default': "'No Errors'", 'max_length': '100', 'null': 'True'}),
