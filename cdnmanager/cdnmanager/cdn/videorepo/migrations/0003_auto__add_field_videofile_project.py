...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoFile.project'
        db.add_column('videorepo_videofile', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videorepo.VideoProject'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VideoFile.project'
        db.delete_column('videorepo_videofile', 'project_id')
