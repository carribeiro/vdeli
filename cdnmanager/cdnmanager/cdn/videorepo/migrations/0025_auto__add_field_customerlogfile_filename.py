...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomerLogfile.filename'
        db.add_column('videorepo_customerlogfile', 'filename', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CustomerLogfile.filename'
        db.delete_column('videorepo_customerlogfile', 'filename')
