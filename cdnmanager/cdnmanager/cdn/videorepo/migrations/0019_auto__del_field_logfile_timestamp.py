...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Logfile.timestamp'
        raise RuntimeError("Cannot reverse this migration. 'Logfile.timestamp' and its values cannot be restored.")
