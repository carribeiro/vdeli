...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CDNServer.username'
        db.add_column('videorepo_cdnserver', 'username', self.gf('django.db.models.fields.CharField')(default='vdeliadmin', max_length=20), keep_default=False)

        # Adding field 'CDNServer.password'
        db.add_column('videorepo_cdnserver', 'password', self.gf('django.db.models.fields.CharField')(default='vDe11Admin', max_length=20), keep_default=False)

        # Adding field 'Logfile.timestamp'
        db.add_column('videorepo_logfile', 'timestamp', self.gf('django.db.models.fields.CharField')(default='20110616', max_length=8), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CDNServer.username'
        db.delete_column('videorepo_cdnserver', 'username')

        # Deleting field 'CDNServer.password'
        db.delete_column('videorepo_cdnserver', 'password')

        # Deleting field 'Logfile.timestamp'
        db.delete_column('videorepo_logfile', 'timestamp')
    ...
    models = {
        ...
        'videorepo.cdnserver': {
            ...
            'timezone': ('django.db.models.fields.CharField', [], {'default': "'America/Sao_Paulo'", 'max_length': '100'}),
        ...
        'videorepo.logfile': {
            ...
            'copy_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'creation_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_error_msg': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            ...
            'timestamp': ('django.db.models.fields.CharField', [], {'max_length': '8'})
        },
