...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Logfile.logfile'
        db.add_column('videorepo_logfile', 'logfile', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Logfile.logfile'
        db.delete_column('videorepo_logfile', 'logfile')
