...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoFile.file_name'
        db.alter_column('videorepo_videofile', 'file_name', self.gf('django.db.models.fields.files.FileField')(max_length=250))


    def backwards(self, orm):
        
        # Changing field 'VideoFile.file_name'
        db.alter_column('videorepo_videofile', 'file_name', self.gf('django.db.models.fields.files.FileField')(max_length=100))
