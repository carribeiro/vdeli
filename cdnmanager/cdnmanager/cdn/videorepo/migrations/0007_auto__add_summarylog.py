...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SummaryLog'
        db.create_table('videorepo_summarylog', (
            ...
            ('new_requests', self.gf('django.db.models.fields.IntegerField')()),
            ('concurrent_requests', self.gf('django.db.models.fields.IntegerField')()),
            ('total_transfer_mb', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('videorepo', ['SummaryLog'])


    def backwards(self, orm):
        
        # Deleting model 'SummaryLog'
        db.delete_table('videorepo_summarylog')
    ...
    models = {
        ...
        'videorepo.projectpolicy': {
            ...
            'segment_size_kb': ('django.db.models.fields.IntegerField', [], {'default': '1000'}),
