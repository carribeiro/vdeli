...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProjectPolicy.max_bandwidth_per_segment_mbps'
        db.delete_column('videorepo_projectpolicy', 'max_bandwidth_per_segment_mbps')

        # Deleting field 'ProjectPolicy.segment_size'
        db.delete_column('videorepo_projectpolicy', 'segment_size')

        # Adding field 'ProjectPolicy.segment_size_kb'
        db.add_column('videorepo_projectpolicy', 'segment_size_kb', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'ProjectPolicy.max_bandwidth_per_segment_kbps'
        db.add_column('videorepo_projectpolicy', 'max_bandwidth_per_segment_kbps', self.gf('django.db.models.fields.IntegerField')(default=1000), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ProjectPolicy.max_bandwidth_per_segment_mbps'
        db.add_column('videorepo_projectpolicy', 'max_bandwidth_per_segment_mbps', self.gf('django.db.models.fields.IntegerField')(default=1000), keep_default=False)

        # Adding field 'ProjectPolicy.segment_size'
        db.add_column('videorepo_projectpolicy', 'segment_size', self.gf('django.db.models.fields.IntegerField')(default=1000), keep_default=False)

        # Deleting field 'ProjectPolicy.segment_size_kb'
        db.delete_column('videorepo_projectpolicy', 'segment_size_kb')

        # Deleting field 'ProjectPolicy.max_bandwidth_per_segment_kbps'
        db.delete_column('videorepo_projectpolicy', 'max_bandwidth_per_segment_kbps')
    ...
    models = {
        ...
        'videorepo.projectpolicy': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_bandwidth_per_segment_kbps': ('django.db.models.fields.IntegerField', [], {'default': '1000'}),
            'max_simultaneous_segments': ('django.db.models.fields.IntegerField', [], {}),
            'protocol': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'segment_size_kb': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
