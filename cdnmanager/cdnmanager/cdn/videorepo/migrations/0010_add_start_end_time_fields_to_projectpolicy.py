...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectPolicy.start_time'
        db.add_column('videorepo_projectpolicy', 'start_time', self.gf('django.db.models.fields.TimeField')(default=datetime.time(23, 0)), keep_default=False)

        # Adding field 'ProjectPolicy.end_time'
        db.add_column('videorepo_projectpolicy', 'end_time', self.gf('django.db.models.fields.TimeField')(default=datetime.time(4, 0)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProjectPolicy.start_time'
        db.delete_column('videorepo_projectpolicy', 'start_time')

        # Deleting field 'ProjectPolicy.end_time'
        db.delete_column('videorepo_projectpolicy', 'end_time')
