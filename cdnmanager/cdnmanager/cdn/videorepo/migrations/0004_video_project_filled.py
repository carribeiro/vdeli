...
#        usr = orm.User.objects.all()[0]
        usr = orm['auth.User'].objects.all()[0]
        
        vp = orm.VideoProject(name='default video project',\
                              creation_date='2011-04-23 00:00:00',
                              user=usr)
        vp.save()
        
        vp = orm.VideoProject.objects.get(name='default video project')
        
        for vfile in orm.VideoFile.objects.all():
            vfile.project = vp
            vfile.save()
