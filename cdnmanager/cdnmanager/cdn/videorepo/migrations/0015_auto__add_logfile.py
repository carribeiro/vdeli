...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('videorepo_logfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videorepo.CDNServer'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('log_length', self.gf('django.db.models.fields.IntegerField')()),
            ('log_lines', self.gf('django.db.models.fields.IntegerField')()),
            ('creation_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('copy_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('last_error_msg', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('videorepo', ['Logfile'])


    def backwards(self, orm):
        
        # Deleting model 'Logfile'
        db.delete_table('videorepo_logfile')
